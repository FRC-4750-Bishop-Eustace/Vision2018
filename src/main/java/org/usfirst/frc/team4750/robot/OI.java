...
import org.usfirst.frc.team4750.robot.commands.RunVision;
...
public class OI {
	...
	Button visionButton = new JoystickButton(driveStick, 2);
	Button ledButton = new JoystickButton(driveStick, 3);
	Button camButton = new JoystickButton(driveStick, 4);
	
	public OI() {
		visionButton.whenReleased(new RunVision());
